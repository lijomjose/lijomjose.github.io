...
<p class="location-address">My cabin is in <strong>AB5, on the 5th floor, in Faculty Zone 1</strong>.</p>

The floor layout below shows Faculty Zone 1. My cabin is highlighted in yellow.

<div class="location-map">
  <img src="/images/Wheretofindme.png" alt="AB5 5th floor Faculty Zone 1 layout with my cabin highlighted in yellow">
</div>
...
- Blog: [Notes from a CS classroom](https://rising-beyond-ai.hashnode.dev/)
